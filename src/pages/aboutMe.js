...
export default function AboutMe() {
   return (
      <div className='container'>
         <h1>Grant Matejka </h1>
         <h3>San Luis Obispo, California · (661) 808-8874 · grantmatejka1@gmail.com </h3>
         <p>My education, professional experience and personal interest has lead me to experiment with and develop skills in anything from Algorithms to Data structures to Full Stack Web Development to Game Design/Development and so much more.
         Utilizing knowledge of numerous Programming Languages (Java, JavaScript, C#, C++, C, ...) and Frameworks (React Native, ASP.NET Core 3.0, Blazor, ...) I have had a thrill exploring and growing in the field of Software Development.
         My coding experience that isn't able to be described fully here is available on my GitHub, including numerous projects and experiments. For insight into my work experience please refer to my LinkedIn or download my resume.
         </p>
         ...
         <p>
            ...
            Credits
            Many thanks to Start Bootstrap for cool templates like this one.
            For more information feel free to visit my github, linkedIn, resume or reach out to me!
         </p>
      </div>
   );
}